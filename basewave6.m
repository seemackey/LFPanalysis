...
function [wave,period,scale,coi]=basewave6(Y,adrate,Laxis,Naxis,k0,dj,waitc,logswitch)
...
period = fourier_factor*scale1;                                 % az újfajta, fourier frekvenciáknak megfelelo period
...
%powerx = (powerx*1000)/adrate;                                  % ez egy korrekció, ami a torrence-ben nem volt benne
