function [eegcb, eegbb, eegmb, trig01, OutlierIdxUnique] = rejectartifacts(eegcb,eegbb,trig01,eegmb)
    %% Artifact reject
    % takes baseline corrected and epoched lfp, csd, mua and returns clean data
    %preallocate
    mmax = zeros(size(eegmb,2),1);
    ...
    OutlierIdx=[OutlieridxC; OutlieridxB; OutlieridxM];
